/* 
  ...
  data entry for shipment of user to records
*/ 
...
public class addShipmentRecord extends HttpServlet{
    ...
    protected void doGet( HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String Snam = request.getParameter("pnum");
        String Stat = request.getParameter("jnum");
        String Scity = request.getParameter("quant");
    ...
    private String do_update(String snum, String sname, String status, String city) throws SQLException {
        ...
        row_updates = database_statement.executeUpdate("insert into shipments values("+ "'"  +snum + "'" + "," + "'"+sname+"'"+ ","+"'" +status+"'" + ","+"" +city+""+ ")");
